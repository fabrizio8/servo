...
pub mod basic_shape {
    ...
    use crate::gecko_bindings::structs::{StyleBasicShape, StyleBasicShapeType, StyleFillRule};
    ...
    use crate::values::generics::basic_shape::{Circle, Ellipse, FillRule, Path, PolygonCoord};
    ...
    impl StyleShapeSource {
        ...
        fn to_svg_path(&self) -> Option<SVGPathData> {
            use crate::gecko_bindings::structs::StylePathCommand;
